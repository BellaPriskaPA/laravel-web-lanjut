  ...
  <nav class="bg-black text-white">
    <div class="container mx-auto flex justify-end items-center py-4 px-6">
      <ul class="flex space-x-8 text-lg font-bold">
        ...
        <li><a class="hover:text-yellow-500 active" href="/kuliner">KULINER</a></li>
...
<!-- Main Content -->
  <main class="container mx-auto py-8">
    <div class="flex flex-col lg:flex-row lg:space-x-8">
        <div class="lg:w-1/2">
            <img alt="{{$culinary->business_name}}" class="w-full" height="500" src="{{ asset('storage/img/'. $culinary->image)}}" width="400"/>
        </div>
            <div class="lg:w-1/2">
                <h1 class="text-3xl font-bold mb-4">
                {{$culinary->business_name}} 
                </h1>
                <p class="text-yellow-500 mb-4">
                berasal dari {{$culinary->area}} 
                </p>
                <p class="mb-4">
                Kategori Produk:
                ...
                <div class="mb-8">
                    ...
                    <div class="flex justify-start space-x-6 mb-4">
                        <a class="text-yellow-800 hover:text-yellow-500" href="{{$culinary->instagram}}" title="Instagram">
                            <i class="fab fa-instagram text-2xl">
                            </i>
                        </a>
                        <a class="text-yellow-800 hover:text-yellow-500" href="{{$culinary->facebook}}" title="Facebook">
                        ...
                        <a class="text-yellow-800 hover:text-yellow-500" href="{{$culinary->address}}" title="Maps">
                    ...
                    <p>
                        ...
                        @if(is_null($culinary->phone_number))
            ...
            <div class="mt-8">
                ...
                <form id="commentForm" action="{{ route('culinaryDetail.store', $culinary->id)}}" method="post">
                    @csrf
                    <input type="hidden", name="culinary_id" value="{{$culinary->id}}">
                    <div class="mb-4">
            ...
            <div class="mt-8">
                ...
                <div id="commentsList" class="space-y-4 max-h-64 overflow-y-auto">
                    @if($culinary->reviews->isEmpty())
                        <p class=" text-center text-xl">Belum Ada Ulasan</p>
                    @else
                        @foreach($culinary->reviews as $review)
