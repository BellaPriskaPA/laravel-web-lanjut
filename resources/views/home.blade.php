...
<div class="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
    ...
    <p class="mt-4">SIPAPO Sipaling Ponorogo. Sipapo adalah sebuah platform yang menyediakan informasi seputar UMKM, kuliner, dan batik di Ponorogo.</p>
...
<main id="mainContent" class="container mx-auto py-16 px-6">
    <h2 class="text-3xl font-bold">SIPAPO <span class="text-yellow-500">Sipaling Ponorogo</span></h2>
    <p class="mt-4">SIPAPO, singkatan dari Sipaling Ponorogo, adalah sebuah platform inovatif yang menghadirkan informasi lengkap tentang UMKM, kuliner, dan batik khas Ponorogo. Dibuat oleh mahasiswa Teknik Informatika Universitas Muhammadiyah Ponorogo, platform ini menjadi wujud nyata dukungan kami terhadap UMKM lokal sekaligus bentuk pengabdian kepada masyarakat.</p>
    <div class="mt-8 flex flex-col md:flex-row">
      <div class="md:w-1/2 space-y-6">
        <div class="flex items-start">
          <i class="fas fa-question text-2xl text-yellow-500"></i>
          <div class="ml-4">
            <h3 class="text-xl font-bold">Tujuan kami</h3>
            <p>Mempromosikan UMKM: Membantu UMKM lokal, khususnya di bidang kuliner dan batik, untuk lebih dikenal masyarakat luas.</p>
            <p>Mudah Diakses: Memudahkan Anda menemukan informasi terkait UMKM, kuliner, dan batik di Ponorogo.</p>
          </div>
        </div>
        <div class="flex items-start">
        <i class="fas fa-history text-2xl text-yellow-500"></i>
          <div class="ml-4">
            <h3 class="text-xl font-bold">Dibuat sejak Desember 2024</h3>
            <p>Website ini, dibuat mulai Desember 2024 sebagai platform informasi dan promosi UMKM.</p>
          </div>
        </div>
        <div class="flex items-start">
          <i class="fas fa-star text-2xl text-yellow-500"></i>
          <div class="ml-4">
            <h3 class="text-xl font-bold">Fitur Andalan Kami</h3>
            ...
            <p class="mt-4">Melalui SIPAPO, kami ingin menjadi jembatan penghubung antara Anda dan kekayaan budaya serta potensi lokal Ponorogo. Mari dukung UMKM dan jadikan Ponorogo semakin dikenal!</p>
          </div>
        </div>
      </div>
